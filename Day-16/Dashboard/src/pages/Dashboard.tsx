  ...
  return (
    <div className="bg-gray-100 min-h-screen flex container mx-auto">
      <div className={`w-15 h-screen ${isMobile ? 'hidden' : 'block'}`}>
        <MyDrawer open={openSidebar} onClose={() => setOpenSidebar(false)} isLoading={false} />
      </div>

      <div className="flex-1 py-2 px-6">
        <TopBar onToggleSidebar={handleToggleSidebar} showHamburger={isMobile} isLoading={false} />
